...
impl Cs2SettingsDialog {
    pub(super) fn new(settings: Settings, cx: &mut Context<Self>) -> Self {
        ...
        Self {
            ...
            fade_out,
            fade_in,
            active_round_motion: Default::default(),
            player_dead_motion: Default::default(),
            between_rounds_motion: Default::default(),
            fade_out_motion: Default::default(),
            fade_in_motion: Default::default(),
